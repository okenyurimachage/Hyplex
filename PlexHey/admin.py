...
class bookingAdmin(admin.ModelAdmin, ExportCsvMixin ):
    list_display = ['fullname', 'phonenumber', 'car_make1', 'car_model1', 'pickupdate','car_price', 'days','amount','user','created_at']
    readonly_fields = ['fullname', 'phonenumber', 'car_make1', 'car_model1', 'pickupdate', 'car_price', 'days','amount','user','created_at']
    list_filter = ['created_at']
